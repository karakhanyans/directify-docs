...
icon: "folder-plus"
description: 'Create, edit, and manage listings in your business directory website'
---
...
<Warning>
  ...
  Explore the complete [ScreenshotOne integration guide](/essentials/integrations#screenshotone).
</Warning>
