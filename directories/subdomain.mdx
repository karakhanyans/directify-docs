...
icon: "globe"
description: 'Learn how to manage and customize your directory subdomain in Directify. Understand subdomain creation, customization options, and important considerations for URL changes.'
---
...
<Frame>
  <iframe width="100%" height="400" src="https://www.youtube.com/embed/P9aPlRXbPes?si=CJqfVzRWlVJ3Wpw1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</Frame>
