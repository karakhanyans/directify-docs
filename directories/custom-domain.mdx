...
### TXT Record for SSL Verification (Required)

Add this TXT record to enable SSL certificate issuance:

| Type | Name | Value |
|------|------|-------|
| TXT | `_acme-challenge.yourdomain.com` | *(Copy the value shown in the setup wizard)* |
