...
<Tabs>
  <Tab title="Option 1: Nameservers (Recommended)">
    ...
    **Update your nameservers at your domain registrar to:**
    ...
    <Warning>
      **Before switching nameservers:** If you have existing DNS records (like email MX records), note them down first. After switching to Directify nameservers, you'll need to contact support to add any additional records you need.
    </Warning>
  </Tab>
