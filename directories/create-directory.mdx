...
icon: "folder-plus"
description: 'Step-by-step guide to creating your first directory website with Directify. Learn how to set up your directory name, title, and description, with options for SEO optimization and future customization.'
---
