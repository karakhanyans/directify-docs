---
title: 'Development'
description: 'Complete guide to local development with Mintlify. Learn how to install, run, and deploy documentation, including port configuration, link validation, and troubleshooting common issues.'
---
