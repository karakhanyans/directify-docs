...
description: 'Complete guide to using the Directify Chrome Extension. Learn how to generate API keys, install the extension, and save websites to your directory with one click, including bulk saving and automatic metadata collection.'
icon: 'chrome'
---
