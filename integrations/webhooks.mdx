...
description: 'Receive real-time notifications when events occur in your Directify account'
icon: 'webhook'
---
...
| `directory.updated` | Directory Updated |
| `directory.deleted` | Directory Deleted |
| `custompage.created` | Custom Page Created |
| `custompage.updated` | Custom Page Updated |
| `custompage.deleted` | Custom Page Deleted |
